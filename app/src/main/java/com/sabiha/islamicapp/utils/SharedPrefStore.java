package com.sabiha.islamicapp.utils;
...
public class SharedPrefStore {
    private static final String APP_PREFS_NAME = "SharedPrefStore";
    ...
    private static final String LAST_APP_ID = "lastAppId";
    private static final String LAST_UPDATE_CODE = "lastUpdateCode";
    private static final String APP_TABLE_NAME = "appTableName";
    ...
    public int getLastAppId(){
        return appSharedPrefs.getInt(LAST_APP_ID,0);//o means didn't create yet
    }

    public void setLastAppId(int id){
        prefsEditor.putInt(LAST_APP_ID, id);
        prefsEditor.commit();
    }
    ...
    public void saveAppTableName(String tableName){
        prefsEditor.putString(APP_TABLE_NAME,tableName);
        prefsEditor.commit();
    }
    public String getAppTableName(){
        return appSharedPrefs.getString(APP_TABLE_NAME,null);
    }
